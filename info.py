...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002227601552'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002241332027').split()]  # For Multiple Id Use One Space Between Each.
